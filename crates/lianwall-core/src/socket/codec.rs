...
mod tests {
    ...
    fn test_json_roundtrip() {
        use super::super::protocol::{Request, Response, ResponseData};
        ...
        // 测试 Response
        let response = Response::with_data(ResponseData::Pong);
        let mut buffer = Vec::new();
        ...
        assert!(matches!(received.data, Some(ResponseData::Pong)));
    }
